...
public class KtoonActivity extends AppCompatActivity implements View.OnClickListener  {
    public static String url = NaverActivity.base_url + "webtoon.php";
    private GettingPHP gPHP;

    private String site = "케이툰";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ktoon);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("케이툰");
    ...
    class GettingPHP extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String str) {
            try {
                ...
                DBOpenHelper dbOpenHelper = new DBOpenHelper(KtoonActivity.this);
                dbOpenHelper.open();

                for(int i=0; i<title.size(); i++){
                    FrameLayout frameLayout = new FrameLayout(KtoonActivity.this);
                    frameLayout.setLayoutParams(new FrameLayout.LayoutParams(width - fifty, fifty));

                    imageView[i] = new ImageView(KtoonActivity.this);
                    ...
                    textView[i] = new TextView(KtoonActivity.this);
                    ...
                    button[i] = new Button(KtoonActivity.this);
                    button[i].setId(i+1);
                    ...
                    button[i].setBackgroundDrawable(ContextCompat.getDrawable(KtoonActivity.this, R.drawable.btn_bg));
                    button[i].setText("                     " + title.get(i));

                    alertButton[i] = new ImageButton(KtoonActivity.this);
                    String id_ = "999" + (i + 1);
                    ...
                    if(c.moveToNext() != false){
                        alertButton[i].setBackgroundDrawable(ContextCompat.getDrawable(KtoonActivity.this, R.drawable.alert_paint));
                    }
                    else{
                        alertButton[i].setBackgroundDrawable(ContextCompat.getDrawable(KtoonActivity.this, R.drawable.alert));
                    }

                    LinearLayout linearLayout1 = new LinearLayout(KtoonActivity.this);
                    linearLayout1.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, fifty));
                    linearLayout1.setBackgroundDrawable(ContextCompat.getDrawable(KtoonActivity.this, R.drawable.btn_bg));
                ...
                for(int i=0; i<button.length; i++){
                    button[i].setOnClickListener(KtoonActivity.this);
                }

                for(int i=0; i<alertButton.length; i++){
                    alertButton[i].setOnClickListener(KtoonActivity.this);
                }
