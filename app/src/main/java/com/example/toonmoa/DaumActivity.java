...
public class DaumActivity extends AppCompatActivity implements View.OnClickListener  {
    public static String url = NaverActivity.base_url + "webtoon.php";
    private GettingPHP gPHP;

    private String site = "다음";
    ...
    class GettingPHP extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String str) {
            try {
                ...
                DBOpenHelper dbOpenHelper = new DBOpenHelper(DaumActivity.this);
                dbOpenHelper.open();

                for(int i=0; i<title.size(); i++){
                    FrameLayout frameLayout = new FrameLayout(DaumActivity.this);
                    frameLayout.setLayoutParams(new FrameLayout.LayoutParams(width - fifty, fifty));

                    imageView[i] = new ImageView(DaumActivity.this);
                    ...
                    textView[i] = new TextView(DaumActivity.this);
                    ...
                    button[i] = new Button(DaumActivity.this);
                    button[i].setId(i+1);
                    ...
                    button[i].setBackgroundDrawable(ContextCompat.getDrawable(DaumActivity.this, R.drawable.btn_bg));
                    button[i].setText("                     " + title.get(i));

                    alertButton[i] = new ImageButton(DaumActivity.this);
                    String id_ = "999" + (i + 1);
                    ...
                    if(c.moveToNext() != false){
                        alertButton[i].setBackgroundDrawable(ContextCompat.getDrawable(DaumActivity.this, R.drawable.alert_paint));
                    }
                    else{
                        alertButton[i].setBackgroundDrawable(ContextCompat.getDrawable(DaumActivity.this, R.drawable.alert));
                    }

                    LinearLayout linearLayout1 = new LinearLayout(DaumActivity.this);
                    linearLayout1.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, fifty));
                    linearLayout1.setBackgroundDrawable(ContextCompat.getDrawable(DaumActivity.this, R.drawable.btn_bg));
                ...
                for(int i=0; i<button.length; i++){
                    button[i].setOnClickListener(DaumActivity.this);
                }

                for(int i=0; i<alertButton.length; i++){
                    alertButton[i].setOnClickListener(DaumActivity.this);
                }
